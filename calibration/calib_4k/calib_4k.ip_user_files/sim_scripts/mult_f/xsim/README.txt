...
#
# Generated by export_simulation on Sun May 09 10:07:41 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './mult_f.sh' script.
...
./mult_f.sh -noclean_files

For more information on the script, please type './mult_f.sh -help'.
