...
#set_property PACKAGE_PIN A10 [get_ports HDMI_RX_CLK_P_IN]
#create_clock -name rx_mgt_refclk -period 3.367 [get_ports HDMI_RX_CLK_P_IN]

##FMC_HPC_DP0_M2C_P
#set_property PACKAGE_PIN D8 [get_ports {HDMI_RX_DAT_P_IN[0]}]
##FMC_HPC_DP1_M2C_P
#set_property PACKAGE_PIN C6 [get_ports {HDMI_RX_DAT_P_IN[1]}]
##FMC_HPC_DP2_M2C_P
#set_property PACKAGE_PIN B8 [get_ports {HDMI_RX_DAT_P_IN[2]}]

##FMC_HPC_LA20_N
#set_property PACKAGE_PIN Y30 [get_ports RX_HPD_OUT]
...
##FMC_HPC_LA16_P
#set_property PACKAGE_PIN K37 [get_ports RX_DDC_OUT_scl_io]
##FMC_HPC_LA16_N
#set_property PACKAGE_PIN K38 [get_ports RX_DDC_OUT_sda_io]

#set_property IOSTANDARD LVDS [get_ports RX_REFCLK_P_OUT]
##FMC_HPC_LA00_CC_P
#set_property PACKAGE_PIN K39 [get_ports RX_REFCLK_P_OUT] 

#set_property IOSTANDARD LVCMOS18 [get_ports RX_DET_IN]
##FMC_HPC_LA03_P
#set_property PACKAGE_PIN M42 [get_ports RX_DET_IN]

## HDMI TX
##FMC_HPC_GBTCLK1_M2C_C_P
#set_property PACKAGE_PIN E10 [get_ports TX_REFCLK_P_IN]
...
##FMC_HPC_LA27_P
#set_property PACKAGE_PIN J31 [get_ports HDMI_TX_CLK_P_OUT]
##FMC_HPC_DP0_C2M_P
#set_property PACKAGE_PIN E2 [get_ports {HDMI_TX_DAT_P_OUT[0]}]
##FMC_HPC_DP1_C2M_P
#set_property PACKAGE_PIN D4 [get_ports {HDMI_TX_DAT_P_OUT[1]}]
##FMC_HPC_DP2_C2M_P
#set_property PACKAGE_PIN C2 [get_ports {HDMI_TX_DAT_P_OUT[2]}]

#set_property IOSTANDARD LVCMOS18 [get_ports TX_HPD_IN]
##FMC_HPC_LA31_N
#set_property PACKAGE_PIN M29 [get_ports TX_HPD_IN]

#set_property IOSTANDARD LVCMOS18 [get_ports TX_DDC_OUT_scl_io]
#set_property IOSTANDARD LVCMOS18 [get_ports TX_DDC_OUT_sda_io]
##FMC_HPC_LA29_P
#set_property PACKAGE_PIN T29 [get_ports TX_DDC_OUT_scl_io]
##FMC_HPC_LA29_N
#set_property PACKAGE_PIN T30 [get_ports TX_DDC_OUT_sda_io]
...
##FMC_HPC_LA06_P
#set_property PACKAGE_PIN K42 [get_ports fmch_iic_scl_io]
#set_property IOSTANDARD LVCMOS18 [get_ports fmch_iic_sda_io]
##FMC_HPC_LA06_N
#set_property PACKAGE_PIN J42 [get_ports fmch_iic_sda_io]
...
##FMC_HPC_LA10_P
#set_property PACKAGE_PIN N38 [get_ports SI5324_RST_OUT]

#set_property IOSTANDARD LVCMOS18 [get_ports SI5324_LOL_IN]
##FMC_HPC_LA02_N
#set_property PACKAGE_PIN N41 [get_ports SI5324_LOL_IN]

#set_property IOSTANDARD LVCMOS18 [get_ports TX_EN_OUT]
##FMC_HPC_LA26_P
#set_property PACKAGE_PIN J30 [get_ports TX_EN_OUT]

#set_property IOSTANDARD LVCMOS18 [get_ports TX_CLKSEL_OUT]
##FMC_HPC_LA18_CC_P
#set_property PACKAGE_PIN M32 [get_ports TX_CLKSEL_OUT]

#set_property IOSTANDARD LVCMOS18 [get_ports RX_I2C_EN_N_OUT]
##FMC_HPC_LA22_P
#set_property PACKAGE_PIN R28 [get_ports RX_I2C_EN_N_OUT]
...
# HDMI RX
#FMC_HPC_GBTCLK0_M2C_C_P
set_property PACKAGE_PIN K8 [get_ports HDMI_RX_CLK_P_IN]
create_clock -name rx_mgt_refclk -period 3.367 [get_ports HDMI_RX_CLK_P_IN]

#FMC_HPC_DP0_M2C_P
set_property PACKAGE_PIN P8 [get_ports {HDMI_RX_DAT_P_IN[0]}]
#FMC_HPC_DP1_M2C_P
set_property PACKAGE_PIN N6 [get_ports {HDMI_RX_DAT_P_IN[1]}]
#FMC_HPC_DP2_M2C_P
set_property PACKAGE_PIN L6 [get_ports {HDMI_RX_DAT_P_IN[2]}]

#FMC_HPC_LA20_N
set_property PACKAGE_PIN V34 [get_ports RX_HPD_OUT]
set_property IOSTANDARD LVCMOS18 [get_ports RX_HPD_OUT]

set_property IOSTANDARD LVCMOS18 [get_ports RX_DDC_OUT_scl_io]
set_property IOSTANDARD LVCMOS18 [get_ports RX_DDC_OUT_sda_io]
#FMC_HPC_LA16_P
set_property PACKAGE_PIN AJ40 [get_ports RX_DDC_OUT_scl_io]
#FMC_HPC_LA16_N
set_property PACKAGE_PIN AJ41 [get_ports RX_DDC_OUT_sda_io]

set_property IOSTANDARD LVDS [get_ports RX_REFCLK_P_OUT]
#FMC_HPC_LA00_CC_P
set_property PACKAGE_PIN AD40 [get_ports RX_REFCLK_P_OUT] 

set_property IOSTANDARD LVCMOS18 [get_ports RX_DET_IN]
#FMC_HPC_LA03_P
set_property PACKAGE_PIN AJ42 [get_ports RX_DET_IN]
...
set_property IOSTANDARD LVDS [get_ports HDMI_TX_CLK_P_OUT]
#FMC_HPC_LA27_P
set_property PACKAGE_PIN P32 [get_ports HDMI_TX_CLK_P_OUT]
#FMC_HPC_DP0_C2M_P
set_property PACKAGE_PIN N2 [get_ports {HDMI_TX_DAT_P_OUT[0]}]
#FMC_HPC_DP1_C2M_P
set_property PACKAGE_PIN M4 [get_ports {HDMI_TX_DAT_P_OUT[1]}]
#FMC_HPC_DP2_C2M_P
set_property PACKAGE_PIN L2 [get_ports {HDMI_TX_DAT_P_OUT[2]}]

set_property IOSTANDARD LVCMOS18 [get_ports TX_HPD_IN]
#FMC_HPC_LA31_N
set_property PACKAGE_PIN V40 [get_ports TX_HPD_IN]

set_property IOSTANDARD LVCMOS18 [get_ports TX_DDC_OUT_scl_io]
set_property IOSTANDARD LVCMOS18 [get_ports TX_DDC_OUT_sda_io]
#FMC_HPC_LA29_P
set_property PACKAGE_PIN W36 [get_ports TX_DDC_OUT_scl_io]
#FMC_HPC_LA29_N
set_property PACKAGE_PIN W37 [get_ports TX_DDC_OUT_sda_io]
...
set_property IOSTANDARD LVCMOS18 [get_ports fmch_iic_scl_io]
#FMC_HPC_LA06_P
set_property PACKAGE_PIN AD38 [get_ports fmch_iic_scl_io]
set_property IOSTANDARD LVCMOS18 [get_ports fmch_iic_sda_io]
#FMC_HPC_LA06_N
set_property PACKAGE_PIN AE38 [get_ports fmch_iic_sda_io]
...
set_property IOSTANDARD LVCMOS18 [get_ports SI5324_RST_OUT]
#FMC_HPC_LA10_P
set_property PACKAGE_PIN AB41 [get_ports SI5324_RST_OUT]

set_property IOSTANDARD LVCMOS18 [get_ports SI5324_LOL_IN]
#FMC_HPC_LA02_N
set_property PACKAGE_PIN AL39 [get_ports SI5324_LOL_IN]

set_property IOSTANDARD LVCMOS18 [get_ports TX_EN_OUT]
#FMC_HPC_LA26_P
set_property PACKAGE_PIN N33 [get_ports TX_EN_OUT]

set_property IOSTANDARD LVCMOS18 [get_ports TX_CLKSEL_OUT]
#FMC_HPC_LA18_CC_P
set_property PACKAGE_PIN U36 [get_ports TX_CLKSEL_OUT]

set_property IOSTANDARD LVCMOS18 [get_ports RX_I2C_EN_N_OUT]
#FMC_HPC_LA22_P
set_property PACKAGE_PIN W32 [get_ports RX_I2C_EN_N_OUT]
