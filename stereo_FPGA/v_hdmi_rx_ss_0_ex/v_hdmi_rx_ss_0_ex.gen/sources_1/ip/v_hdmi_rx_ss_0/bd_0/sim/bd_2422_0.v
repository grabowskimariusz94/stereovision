...
(* CORE_GENERATION_INFO = "bd_2422_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2422_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "v_hdmi_rx_ss_0.hwdef" *) 
module bd_2422_0
   (AUDIO_OUT_tdata,
    AUDIO_OUT_tid,
    AUDIO_OUT_tready,
  ...
  bd_2422_0_v_hdmi_rx_0 v_hdmi_rx
  ...
  bd_2422_0_v_vid_in_axi4s_0 v_vid_in_axi4s
