...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net net_inverter_0_Res [get_bd_ports hpd] [get_bd_pins inverter_0/Res]
  ...
  connect_bd_net -net net_v_hdmi_rx_hpd [get_bd_pins inverter_0/Op1] [get_bd_pins v_hdmi_rx/hpd]
