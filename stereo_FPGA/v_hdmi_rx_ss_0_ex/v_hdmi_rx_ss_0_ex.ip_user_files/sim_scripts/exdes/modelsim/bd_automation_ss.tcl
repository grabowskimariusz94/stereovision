...
#  set link_rate  [get_property CONFIG.LINK_RATE $parentCell ]
  ...
  set_property -dict [list CONFIG.C_Tx_Protocol {None} CONFIG.C_GT_DIRECTION {SIMPLEX_RX} CONFIG.C_INPUT_PIXELS_PER_CLOCK $ppc CONFIG.C_TX_PLL_SELECTION $pll_type_tx CONFIG.C_RX_PLL_SELECTION $pll_type_rx ] [get_bd_cells ${gt_ip_inst}]

  connect_bd_intf_net [get_bd_intf_pins ${parentCell}/SB_STATUS_IN] [get_bd_intf_pins ${gt_ip_inst}/status_sb_rx]
  connect_bd_intf_net [get_bd_intf_pins ${parentCell}/LINK_DATA0_IN] [get_bd_intf_pins ${gt_ip_inst}/rx_axi4s_ch0]
  connect_bd_intf_net [get_bd_intf_pins ${parentCell}/LINK_DATA1_IN] [get_bd_intf_pins ${gt_ip_inst}/rx_axi4s_ch1]
  connect_bd_intf_net [get_bd_intf_pins ${parentCell}/LINK_DATA2_IN] [get_bd_intf_pins ${gt_ip_inst}/rx_axi4s_ch2]

#  connect_bd_net [get_bd_pins ${parentCell}/link_clk] [get_bd_pins ${gt_ip_inst}/rx_axi4s_aclk]
# [get_bd_pins ${gt_ip_inst}/gt_rxusrclk]
  connect_bd_net [get_bd_pins ${parentCell}/video_clk] [get_bd_pins ${gt_ip_inst}/rx_video_clk]
