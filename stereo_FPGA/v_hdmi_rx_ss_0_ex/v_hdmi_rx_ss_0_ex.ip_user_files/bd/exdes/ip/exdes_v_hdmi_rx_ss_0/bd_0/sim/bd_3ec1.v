...
(* CORE_GENERATION_INFO = "bd_3ec1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_3ec1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "exdes_v_hdmi_rx_ss_0.hwdef" *) 
module bd_3ec1
   (AUDIO_OUT_tdata,
    AUDIO_OUT_tid,
    AUDIO_OUT_tready,
  ...
  assign hpd[0] = net_inverter_0_Res;
  ...
  bd_3ec1_inverter_0_0 inverter_0
       (.Op1(net_v_hdmi_rx_hpd),
        .Res(net_inverter_0_Res));
