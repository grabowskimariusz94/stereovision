...
module hdmi_in_uhd_4
  #(
   ...
   //horizontal
   localparam hr=740/4; //resolution
   localparam hp=160; //porch
   //vertical
   localparam vr=497; //resolution
   localparam vp=35; //porch
   ...
   reg [14:0] 	  hcounter = 14'b0;
   reg [14:0] 	  vcounter = 14'b0;  // more ???
   reg [14:0] 	  valid_counter = 14'b0;
	    ...
	    begin
          ...
          init_frame:
            begin
               ...
               rgbfile = $fopen("C:../../../../img_in/im01.ppm", "rb");
