...
`timescale 1 ns / 1 ps
	...
	begin
	    ...
	    begin
            ...
            tdataR[23-:8] <= {1'b0,s_axis_lr_tdata[15-:7]}+{1'b0,lastLR[31-:7]}; 
            tdataL[15-:8] <= {1'b0,s_axis_lr_tdata[7-:7]}+{1'b0,lastLR[23-:7]}; 
            tdataR[7-:8] <= {1'b0,lastLR[31-:7]}+{1'b0,lastLR[15-:7]}; 
        end
    end
