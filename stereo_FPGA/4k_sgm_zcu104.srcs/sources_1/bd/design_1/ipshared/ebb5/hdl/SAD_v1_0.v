...
`timescale 1 ns / 1 ps
    ...
    generate
        ...
        begin: sadsR0
            SAD s (
                .clk(aclk),
                .i_kernel1_data({linesL[2][8*iR0+23-:24],linesR[1][8*iR0+23-:24],linesR[0][8*iR0+23-:24]}),
    ...
    generate
        ...
        begin: sadsR1
            SAD s (
                .clk(aclk),
                .i_kernel1_data({linesL[2][8*iR1+31-:24],linesR[1][8*iR1+31-:24],linesR[0][8*iR1+31-:24]}),
    ...
    generate
        ...
        begin: sadsR2
            SAD s (
                .clk(aclk),
                .i_kernel1_data({linesL[2][8*iR2+39-:24],linesR[1][8*iR2+39-:24],linesR[0][8*iR2+39-:24]}),
    ...
    generate
        ...
        begin: SadsR3
            SAD s (
                .clk(aclk),
                .i_kernel1_data({linesL[2][8*iR3+47-:24],linesR[1][8*iR3+47-:24],linesR[0][8*iR3+47-:24]}),
