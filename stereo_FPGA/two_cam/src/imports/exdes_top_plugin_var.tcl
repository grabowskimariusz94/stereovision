    ...
    array set pin_cmd {
        ...
        TX_REFCLK_IN         {-mode slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0}
        HDMI_RX_CLK_IN       {-mode slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0}
        DRU_CLK_P_IN         {-dir I}       
        DRU_CLK_N_IN         {-dir I}
        ...
        HDMI_DATA            {-mode master -vlnv xilinx.com:interface:gt_rtl:1.0}
        ...
        HDMI_RX_DAT_IN       {-mode master -vlnv xilinx.com:display_aurora:GT_Serial_Transceiver_Pins_RX_rtl:1.0}
        HDMI_TX_DAT_OUT      {-mode master -vlnv xilinx.com:display_aurora:GT_Serial_Transceiver_Pins_TX_rtl:1.0}
        IDT_8T49N241_LOL_IN  {-dir I}
    }
    ...
    array set block_cmd {
        ...
        v_frmbuf_wr             {-type ip -vlnv xilinx.com:ip:v_frmbuf_wr:2.1}
        v_frmbuf_rd             {-type ip -vlnv xilinx.com:ip:v_frmbuf_rd:2.1}
    ...
    if {[array exist config_v_frmbuf_wr]} {
        array unset config_v_frmbuf_wr
    }   
    array set config_v_frmbuf_wr {
    ...
    if {[array exist config_v_frmbuf_rd]} {
        array unset config_v_frmbuf_rd
    }   
    array set config_v_frmbuf_rd {
		CONFIG.AXIMM_ADDR_WIDTH {64}
		CONFIG.HAS_BGR8         {1}
		CONFIG.HAS_BGRX8        {1}
		CONFIG.HAS_RGBX8        {1}
